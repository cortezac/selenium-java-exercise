...
public class NEMO10431_IMPROVED_WIP {
	...
	public void download_app_menu_hint_01() throws Exception{
		...
		C1ProductPageValidations.hint_menu_displayValidation(driver, "Hint_Open");
	}
	@Test
	public void download_app_menu_hint_02() throws Exception{
		...
		C1TeacherDashboardPageActions.viewDetails_link_click(driver);
		System.out.println("product details clicked");
		C1ProductPageValidations.hint_menu_displayValidation(driver, "Hint_Close_01");
	}
	...
	public void download_app_menu_hint_03() throws Exception{
		...
		C1TeacherDashboardPageActions.viewDetails_link_click(driver);
		System.out.println("product details clicked");
		C1ProductPageValidations.hint_menu_displayValidation(driver, "Hint_Close_02");
	}
	...
	public void download_app_menu_hint_04() throws Exception{
		...
		C1TeacherDashboardPageActions.viewDetails_link_click(driver);
		System.out.println("product details clicked");
		C1ProductPageValidations.hint_menu_displayValidation(driver, "Hint_Close_03");
	}
	...
	public void download_app_menu_hint_05() throws Exception{
		...
		C1TeacherDashboardPageActions.viewDetails_link_click(driver);
		System.out.println("product details clicked");
		C1ProductPageValidations.hint_menu_displayValidation(driver, "Hint_Close_04");
	}
}
