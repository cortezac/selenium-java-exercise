...
import sandboxv2.c1.pagevalidations.blue.C1ProductActivationPageValidations;

public class NEMO13443 {
	...
	@Test
	public void  c1_pplus_activation_page_title_changes() throws Exception{
		System.out.println("starting test");
		//initialize variables
		String username = "", password = "", 
				bundleName = "EQA Presentation Plus 01";
		...
		C1ProductPageActions.presentationPlus_link_click(driver);
		System.out.println("presentation plus clicked");
		C1ProductActivationPageValidations.presentationPlus_link_textValidation(driver,bundleName);
	}
